...
export default function Footer() {
  return (
    <footer className="text-gray-600 mx-auto bg-[#eeeef0] mt-20">
      <div className="container px-5 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col max-w-[1440px]">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex font-medium items-center md:justify-start justify-center text-gray-900">
            <h1 className="text-3xl font-bold text-green-400 md:mr-4 lg:text-3xl">
              Auto<span className="text-3xl font-bold text-black lg:text-3xl">Bid</span>
            </h1>
          </a>
        </div>
